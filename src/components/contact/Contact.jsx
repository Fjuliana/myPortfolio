        ...
        <footer id="contact" className={styles.container}>
            ...
            <ul className={styles.links}>
                <li className={styles.link}>
                    <img src={getImageUrl("assets/contacts/gmail.png")} alt="Email icon" />
                    <a href="mailto:faithjuliana44@email.com">faithjuliana44@email.com</a>
                </li>
                <li className={styles.link}>
                    <img
                        src={getImageUrl("assets/contacts/linkedin.png")}
                        alt="LinkedIn icon"
                    />
                    <a href="https://www.linkedin.com/in/faith-juliana-lema-464162302">linkedin.com/faithjulianalema</a>
                </li>
                <li className={styles.link}>
                    <img src={getImageUrl("assets/contacts/github.png")} alt="Github icon" />
